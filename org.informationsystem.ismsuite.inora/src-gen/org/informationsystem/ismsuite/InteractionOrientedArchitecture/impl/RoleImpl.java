 ...
 * </p>
 * <ul>
 *   <li>{@link org.informationsystem.ismsuite.InteractionOrientedArchitecture.impl.RoleImpl#getParticipant <em>Participant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoleImpl extends NamedElementImpl implements Role {
	...
	protected EClass eStaticClass() {
		return InteractionOrientedArchitecturePackage.Literals.ROLE;
	}
	...
	public EList<Participant> getParticipant() {
		if (participant == null) {
			participant = new EObjectWithInverseResolvingEList<Participant>(Participant.class, this,
					InteractionOrientedArchitecturePackage.ROLE__PARTICIPANT,
					InteractionOrientedArchitecturePackage.PARTICIPANT__ROLE);
		}
		return participant;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case InteractionOrientedArchitecturePackage.ROLE__PARTICIPANT:
